    ...
    return (
        <div style={{position:'fixed', top:0, left:0, width:'100%', height:'100%', background:'rgba(0,0,0,0.5)', display:'flex', alignItems:'center', justifyContent:'center'}}>
            <div style={{background:'white', padding:'2rem', borderRadius:'12px', width:'450px'}}>
                <h2 style={{marginTop:0}}>Add New Catalog Item</h2>
                <div style={{display:'flex', flexDirection:'column', gap:'1rem'}}>
                    <input value={description} onChange={e => setDescription(e.target.value)} placeholder="Item Description (e.g., Service Call Fee)" style={{padding:'0.75rem', borderRadius:'6px', border:'1px solid #cbd5e0'}} />
                    <input type="number" value={price} onChange={e => setPrice(e.target.value)} placeholder="Price" style={{padding:'0.75rem', borderRadius:'6px', border:'1px solid #cbd5e0'}} />
                </div>
